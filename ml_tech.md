# Machine Learning Technology Projects

This document lists the ML technology projects found in the YouTube playlist, their GitHub repositories, and main functions.
...
- Supports multi-language code synthesis
...
- Supports file-based context and tool use
- Multi-modal input support (text, code, files)
...
- Fine-tuning resources for code-specific tasks
- State-of-the-art performance on coding benchmarks (SWE-bench, etc.)
...
- Supports autonomous code editing, testing, and debugging
...
- Community reference for o1-style model research
...
- Significantly reduces GPU memory usage for large context lengths
- Widely adopted in state-of-the-art LLM training pipelines
...
- Integrates with development environments and version control
- Supports multi-step code generation, review, and refactoring

---

## Summary Table

| Project | Source Identifier | GitHub URL | Redirects |
|---|---|---|---|
| OpenAI Codex | `openai/codex` | https://github.com/openai/codex | No |
| Gemini CLI | `google-gemini/gemini-cli` | https://github.com/google-gemini/gemini-cli | No |
| Qwen3-Coder | `QwenLM/Qwen3-Coder` | https://github.com/QwenLM/Qwen3-Coder | No |
| OpenHands | `All-Hands-AI/OpenHands` | https://github.com/All-Hands-AI/OpenHands → https://github.com/OpenHands/OpenHands | **Yes** |
| Awesome O1 | `srush/awesome-o1` | https://github.com/srush/awesome-o1 | — |
