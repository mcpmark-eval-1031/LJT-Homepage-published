...
**Status:** FROZEN  
**Date:** 2026-04-09  
**Scan basis:** `review/changeset-v1` branch — post-pilot-changeset snapshot  
**Prior contract:** v1.0.0 (2026-04-08, `dev` branch) — schema unchanged; scan basis updated.
...
`Z` suffix (e.g., `"2026-04-09T00:00:00Z"`).
...
For this rendering cycle the target branch is `review/render-artifact`,
branched from `main` and augmented with the pilot code changes from
`review/changeset-v1`.
